...
| Discovery | Марктинговые исследования, Скетчинг, Fakeware, Приоретизация, минимизируем работу, выявляем потребности и цели, </br> участники: тим лид, аналитик, прожект, продакт - собираемся до тех пор, пока точно придут к единому пониманию что нужно сделать. |
...
| Development | разработка (итерация 0): настройка инфраструктуры проекта, CI|CD и с выкатом на прод. На выходе только hello world и тестовые кейсы. |
