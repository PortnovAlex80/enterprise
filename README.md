...
| Принцип                   | Описание                                                                                           |
|--------------------------|----------------------------------------------------------------------------------------------------|
| Single Responsibility    | Каждый модуль (или класс) имеет одну и только одну причину для изменения. И
Эта причина - актор или пользователь. Если класс или модуль меняется в угоду и
одному и другому актору - это нарушение SRP                |
